...
/**
* original OpenLayers.Control.AdvancedSearch.js
* @author U.S. Department of State, Humanitarian Information Unit
* @version 1.0
*/
...
/**
* original OpenLayers.Control.AdvancedSelectFeature.js
* @author U.S. Department of State, Humanitarian Information Unit
* @version 1.0
*/
...
OpenLayers.Control.AdvancedSelectFeature = OpenLayers.Class(OpenLayers.Control.SelectFeature,
{
    ...
    moveEndTargetFeature: undefined,
    ...
    jit_request: function(f,bFocusOnItem)
    {
    	...
    	if(this.isJITLayer(layer))
    	{
        	...
        	for(var i = 0; i < strategy.getNumberOfJobs(); i++)
        	{
        		...
        		var bJobLoaded = !(strategy.isFeatureLoaded.apply(strategy,[f,j]));
    ...
    panComplete: function(jumped) // Although this is called from a listener to the baseLayer, this function is wrapped and "applied" with the AdvancedSelectFeature object as this
    {
    	...
    	//if(this.atCenter(this.moveEndTargetFeature))
    ...
    focusOnFeature: function(f,a,c,g,z)
    {
    	...
    	else
    	{
    		...
    		if(this.animate)
    		{
    	    	this.moveEndTargetFeature = f;
    	    	this.moveEndTargetLocation = g;
    	    	if(z!=undefined&&z!=this.map.getZoom()&&this.map.isValidZoomLevel(z))
     			{
    ...
    isLoaded: function(f)
	{
    	...
    	{
    		var j = strategy.getJob(i);
    		bLoaded = bLoaded && strategy.isFeatureLoaded.apply(strategy,[f,j]);    		
    	}
    	return bLoaded;
	},
    atCenter: function(c)
    ...
    getNearbyFeatures: function(center,candidateFeatures)
    {
    	...
    	{
    		var nearby = false;
    		if(candidateFeature.geometry.CLASS_NAME=="OpenLayers.Geometry.Collection")
    		{
    		...
    		else if(candidateFeature.geometry.CLASS_NAME=="OpenLayers.Geometry.MultiPolygon")
    		{
    			if(candidateFeature.geometry.intersects(center))
    			{
    				nearby = true;
    ...
    clickFeature: function(f,a,b)
	{
		...
		if(this.isWheelClosed())
		{
			...
			else
			{
				...
				else if(f.geometry.CLASS_NAME=="OpenLayers.Geometry.Collection")
				{
					this.stopWheelTimer();
			       ...
			       // var nearbyFeatures = this.getNearbyFeatures(f);
				...
				else if(f.geometry.CLASS_NAME=="OpenLayers.Geometry.MultiPolygon")
				{
					this.stopWheelTimer();
...
/**
* original OpenLayers.Control.AdvancedSelectFeatureWheel.js
* @author U.S. Department of State, Humanitarian Information Unit
* @version 1.0
*/
...
OpenLayers.Control.AdvancedSelectFeatureWheel = OpenLayers.Class(OpenLayers.Control.SelectFeature,
{
	...
	isLoaded: function(f)
	{
		return this.primary.isLoaded.apply(this.primary,[f]);
	},
...
/**
* original OpenLayers.Control.Bookmarks.js
* @author U.S. Department of State, Humanitarian Information Unit
* @version 1.0
*/
...
({
    ...
    buildTargets: function()
    {
    	...
    	if(bookmark.type=="location")
    	{
    		...
    		{
    			//{"longitude":33.515,"latitude":36.304,"zoom":11
...
/**
* original OpenLayers.Control.Box.js
* @author U.S. Department of State, Humanitarian Information Unit
* @version 1.0
*/
...
/**
* original OpenLayers.Control.Disclaimer.js
* @author U.S. Department of State, Humanitarian Information Unit
* @version 1.0
*/
...
/**
* original OpenLayers.Control.Focus.js
* @author U.S. Department of State, Humanitarian Information Unit
* @version 1.0
*/
...
/**
* original OpenLayers.Control.History.js
* @author U.S. Department of State, Humanitarian Information Unit
* @version 1.0
*/
...
/**
* original OpenLayers.Control.Link.js
* @author U.S. Department of State, Humanitarian Information Unit
* @version 1.0
*/
...
/**
* original OpenLayers.Control.TimeSlider.js
* @author U.S. Department of State, Humanitarian Information Unit
* @version 1.0
*/
...
/**
* original OpenLayers.Control.Title.js
* @author U.S. Department of State, Humanitarian Information Unit
* @version 1.0
*/
...
/**
* original OpenLayers.Format.AdvancedText.js
* @author U.S. Department of State, Humanitarian Information Unit
* @version 1.0
*/
...
/**
* original OpenLayers.Format.SOAP.js
* @author U.S. Department of State, Humanitarian Information Unit
* @version 1.0
*/
...
/**
* original OpenLayers.Layer.HIUTileCache.js
* @author U.S. Department of State, Humanitarian Information Unit
* @version 1.0
*/
...
/**
* original OpenLayers.Layer.Mapbox.js
* @author U.S. Department of State, Humanitarian Information Unit
* @version 1.0
*/
...
OpenLayers.Layer.MapBox = OpenLayers.Class(OpenLayers.Layer.TMS, {
    ...
    initialize: function(name, options) {
        ...
        {
        	newArguments = [name, [protocol+'://a.tiles.mapbox.com/'+options.org+'/',
        	                       protocol+'://b.tiles.mapbox.com/'+options.org+'/',
        	                       protocol+'://c.tiles.mapbox.com/'+options.org+'/',
        	                       protocol+'://c.tiles.mapbox.com/'+options.org+'/'
        	                       ], options];
        }
        else
        {
        	newArguments = [name, [
               protocol+'://a.tiles.mapbox.com/mapbox/',
               protocol+'://b.tiles.mapbox.com/mapbox/',
               protocol+'://c.tiles.mapbox.com/mapbox/',
               protocol+'://c.tiles.mapbox.com/mapbox/'
           ], options];
        }
        OpenLayers.Layer.TMS.prototype.initialize.apply(this, newArguments);
...
/**
* original OpenLayers.Layer.TimeVector.js
* @author U.S. Department of State, Humanitarian Information Unit
* @version 1.0
*/
...
/**
* original OpenLayers.Protocol.SOAP.js
* @author U.S. Department of State, Humanitarian Information Unit
* @version 1.0
*/
...
/**
* original OpenLayers.Strategy.JIT.js
* @author U.S. Department of State, Humanitarian Information Unit
* @version 1.0
*/
...
OpenLayers.Strategy.JIT = OpenLayers.Class(OpenLayers.Strategy.Fixed,
{
    ...
    isFeatureLoaded: function(f,job)
	{
		var bLoaded = false;
    	if(f.attributes!=undefined)
		{
			if(f.attributes.loaded!=undefined)
			{
				if($.isArray(f.attributes.loaded))
				{
					return $.inArray(job,f.attributes.loaded)!=-1;
				}
			}
		}
    	return bLoaded;
    ...
    setLoaded: function(f,j)
    {
		if(f.attributes.loaded==undefined)
		{
			f.attributes.loaded = [];
		}
		f.attributes.loaded.push(j);
    },
