...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'base_classification', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'base', ['Classification'])

        # Adding field 'ResourceBase.classification'
        db.add_column(u'base_resourcebase', 'classification', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.Classification'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'License'
        db.delete_table(u'base_classification')

        # Deleting field 'ResourceBase.classification'
        db.delete_column(u'base_resourcebase', 'classification_id')
    ...
    models = {
        u'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 15, 5, 55, 50, 537635)'}),
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 15, 5, 55, 50, 541214)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 15, 5, 55, 50, 540844)'}),
        ...
        u'base.resourcebase': {
            ...
            'classification': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['base.Clssification']", 'null': 'True', 'blank': 'True'}),
